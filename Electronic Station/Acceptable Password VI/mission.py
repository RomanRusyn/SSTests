...
def is_acceptable_password(password: str) -> bool:
    # your code here
    if len(password) > 6 and any(i.isdigit() for i in password) and any(i.isalpha() for i in password) or len(
            password) > 9:
        return True
    else:
        return False
...
def is_acceptable_password(password):
    ...
    if 'password' not in password.lower() and (
            len(password) > 9 or len(password) > 6 and any(i.isdigit() for i in password) and not password.isdigit()):
        return True
    else:
        return False
...
def is_acceptable_password(password):
    # your code here
    if 'password' not in password.lower() and (len(set(password)) >= 3) and (
            len(password) > 9 or len(password) > 6 and any(i.isdigit() for i in password)
